...
namespace SqlServerWebToolLib.Helpers
{
    public static class SmoHelper
    {
        ...
        private static readonly BindingFlags bf_GetProperty =
            BindingFlags.GetProperty | BindingFlags.Instance | BindingFlags.Public;

        private static readonly BindingFlags bf_SetProperty =
            BindingFlags.SetProperty | BindingFlags.Instance | BindingFlags.Public;

        private static readonly BindingFlags bf_Invoke =
