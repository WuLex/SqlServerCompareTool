...
namespace SqlServerWebToolLib.BLL
{
    public static class CompareDBHelper
    {
        ...
        private static void ThreadWorkAction(object obj)
        {
            ...
            {
                param.Result =
                    param.Instance.GetDbAllObjectScript(param.Instance.ConnectionInfo, param.DbName,
                        param.DbOjbectType);
            }
            catch (Exception ex)
            {
        ...
        public static List<CompareResultItem> CompareDB(string srcConnId, string destConnId, string srcDB,
            string destDB, string flag)
        {
