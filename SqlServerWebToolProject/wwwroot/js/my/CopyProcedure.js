...
function btnRun_click(){
	...
	if( array1.length + array2.length + array3.length == 0 ){
		$.messager.alert(g_MsgBoxTitle, '请选择要复制的项目。','warning'); return false;
	}
	...
	$.ajax({
		...
		data:{  srcConnId: $("#hfSrcConnId").val(), 
				...
				spNames: spNames, viewNames: viewNames, funcNames: funcNames
		},
		complete: function(){ $(".waitMessageStyle").hide(); $("#btnRun").show(); },
